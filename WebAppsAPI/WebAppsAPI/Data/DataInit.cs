...
namespace WebAppsAPI.Data
{
    public class DataInit
    {
        ...
        public async Task InitializeData()
        {
            ...
            {
                User user1 = new User { Email = "sebastienwojtyla@gmail.com", FirstName = "Sebastien", LastName = "Wojtyla" };
                
                await CreateUser(user1.Email, "Azertyuiop1@");

                User user2 = new User { Email = "randomGuy@gmail.com", FirstName = "Random", LastName = "Guy" };
                
                await CreateUser(user2.Email, "Azertyuiop1@");
